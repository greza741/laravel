<nav class="bg-gray-800" x-data="{ isOpen: false }">
            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-navlink href="/posts" :active="request()->is('posts') or request()->is('posts/*')">Blog</x-navlink>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <x-navlin-mobile href="/" :active="request()->is('/')">Home</x-navlin-mobile>
            <x-navlin-mobile href="/posts" :active="request()->is('posts')">Blog</x-navlin-mobile>
            <x-navlin-mobile href="/about" :active="request()->is('about')">About</x-navlin-mobile>
            <x-navlin-mobile href="/contact" :active="request()->is('contact')">Contact</x-navlin-mobile>
